...
export default () => {
    return (
        <div>
            <div className="BorderLeft--Img">
                <img alt='Paint of dionisio' src='https://1.bp.blogspot.com/-knTnrVyDNWo/VaUia58m_9I/AAAAAAAAEYQ/Vuv-Pm-Txcc/s1600/Bacco.jpg' class="Img"/>
